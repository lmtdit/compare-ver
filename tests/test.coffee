...
describe 'compare version', ->
    ...
    it 'compare 2', ->
        ...
        compareVer.gt("1.6.1", "1.7.10").should.equal(-1)
    ...
    it 'compare 8', ->
        ...
        compareVer.gt("1.7.10", "1.6.20").should.greaterThan(0)
    ...
    it 'compare 14', ->
        ...
        compareVer.gt("1.0.7", "1.0.10").should.equal(-1)
