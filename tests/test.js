...
describe('compare version', function() {
  ...
  it('fompare 5', function() {
    ...
    return compareVer("1.7.0", "1.7.00").should.equal(-1);
  });
  ...
  it('compare 7', function() {
    ...
    return compareVer("1.8.0", "1.7").should.greaterThan(0);
  });
  ...
  it('compare 9', function() {
    ...
    return compareVer(1.00001, 1.00002).should.equal(-2);
  });
  ...
  return it('compare 15', function() {
    ...
    return compareVer("1.0.7", "01.0.7").should.equal(0);
  });
});
